...
double getArea(double length, double width){
    // getArea - Asks the user to enter a rectangle's area, and return that value as a double.
    double area = length * width;
    return area;
}

void displayData(double length, double width, double area){
    cout << "retangle's length: " << length << ", retangle's width: " << width << ", retangle's area: " << area << endl;
}